-- ============================================================================
-- CREAR VISTAS (CORREGIDO - Sin columna activo)
-- Ejecutar este script después del anterior
-- ============================================================================

USE inventario_cannon;

-- Eliminar vistas si existen (sin errores)
...
-- ============================================================================
-- Vista: Stock de productos compuestos
-- ============================================================================
...
SELECT '✓ Vista stock_compuestos creada' AS Paso;

-- ============================================================================
-- Vista: Stock disponible ML (productos base + compuestos)
-- ============================================================================
...
SELECT '✓ Vista stock_disponible_ml creada' AS Paso;
...
SELECT '✓ Vista alertas_pendientes creada' AS Paso;
...
SELECT '✓ Vista ventas_activas creada' AS Paso;
...
SELECT TABLE_NAME as 'Vista Creada', '✅' as Estado
...
SELECT '========================================================' AS '';
SELECT '✅ VISTAS LISTAS - Sistema completo funcionando' AS '';
