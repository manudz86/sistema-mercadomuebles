# ============================================================================
# PROCESO DE ENVÍO - RUTAS COMPLETAS
# Agregar después de las rutas de /ventas/activas
# ============================================================================
...
def proceso_cancelar_devolver(venta_id):
    """Cancelar venta en proceso y DEVOLVER stock descontado"""
    conn = get_db_connection()
    cursor = conn.cursor()
    ...
    try:
        ...
        conn.commit()
        flash(f'✅ Venta {venta["numero_venta"]} cancelada. Stock devuelto correctamente.', 'success')
