# ============================================================================
# VERSIÓN SIN BREAKING CHANGES
# Mantiene el nombre procesar_orden_ml() para compatibilidad
# ============================================================================

# ===== FUNCIÓN 1: procesar_orden_ml (MANTIENE EL NOMBRE ORIGINAL) =====
...
def obtener_shipping_completo(shipping_id, access_token):
    ...
    try:
        ...
        if receiver_address:
            ...
            # Ciudad y provincia (CONVERTIR A STRING - ARREGLA ERROR)
            ...
            # Inferir zona (solo si hay ciudad)
...
# ===== FUNCIÓN 3: ml_importar_ordenes (ACTUALIZADA) =====
...
# ===== FUNCIÓN 4: ml_seleccionar_orden (ACTUALIZADA) =====
...
# ===== FUNCIÓN 5: ml_guardar_mapeo (ACTUALIZADA) =====
