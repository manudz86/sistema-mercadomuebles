...
def generar_factura_excel(venta_id):
    ...
    try:
        ...
        # ✅ Respetar el checkbox del template
        ...
        provincia = (venta.get('factura_state') or venta.get('provincia_cliente') or
...
def facturar_multiple_excel():
    ...
    try:
        ...
        # ✅ IDs que tienen el flete marcado en el checkbox
        ...
        for venta in ventas:
            ...
            costo_flete = float(venta.get('costo_flete') or 0)
            # ✅ Incluir flete solo si el checkbox estaba marcado para esta venta
