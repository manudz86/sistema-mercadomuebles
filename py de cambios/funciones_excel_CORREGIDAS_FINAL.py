# ============================================================================
# FUNCIÓN 1: FACTURA INDIVIDUAL (CORREGIDA)
# ============================================================================
...
def generar_factura_excel(venta_id):
    ...
    try:
        ...
        # Provincia - DEFAULT "Capital Federal"
        ...
        # ✅ SKUs (CORREGIDO: solo precio unitario, NO multiplicar)
        for item in items:
            row_data.append(item['sku'])
            row_data.append(int(item['cantidad']))
            row_data.append(float(item['precio_unitario']))  # ✅ Solo precio unitario
...
# ============================================================================
# FUNCIÓN 2: FACTURA MÚLTIPLE (CORREGIDA - SIN TOTAL GENERAL)
# ============================================================================
...
def facturar_multiple_excel():
    ...
    try:
        ...
        for venta in ventas:
            ...
            # Si tiene costo de envío, agregarlo como FLETE
            if venta.get('costo_flete') and venta['costo_flete'] > 0:
                items.append({
                    'sku': 'FLETE',
                    'nombre_producto': 'Costo de Envío',
        ...
        for venta_data in ventas_con_items:
            ...
            # ✅ SKUs (CORREGIDO: solo precio unitario)
            for item in items:
                row_data.append(item['sku'])
                row_data.append(int(item['cantidad']))
                row_data.append(float(item['precio_unitario']))  # ✅ Solo precio unitario
