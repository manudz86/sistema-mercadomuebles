...
def ver_stock():
    ...
    try:
        ...
        # ============================================
        # 1. OBTENER VENTAS ACTIVAS (descompuestas)
        # ============================================
        cursor.execute('''
            SELECT 
        ...
        # Calcular stock disponible de productos base
        ...
        # 3. COMBOS (SOMMIERS)
        # ============================================
        # Solo si no se filtra por tipo de producto base
        if filtro_tipo == 'TODOS' or filtro_tipo == 'sommier':
            ...
            for combo in combos:
                ...
                for comp in componentes:
                    ...
                    # Cuántos combos se pueden armar con este componente
                ...
                productos.append({
                    ...
                    'medida': combo['medida'],
                    'modelo': combo['modelo'],
                    'stock_fisico': '-',  # Los combos no tienen stock físico
