    ...
    try:
        ...
        ventas_activas = query_db('''
            SELECT 
                ...
                SUM(iv.cantidad * COALESCE(c.cantidad, 1)) as vendido
            FROM items_venta iv
            ...
            if productos_combos:
                for combo in productos_combos:
                    ...
                    componentes = query_db('''
                        SELECT sku_componente, cantidad 
                        FROM componentes 
                        WHERE sku_combo = %s
                    ''', (combo['sku'],))
                    ...
                    for comp in componentes:
                        sku_comp = comp['sku_componente']
                        cant_necesaria = int(comp['cantidad'])
                        ...
                        if prod_comp:
                            ...
                            combos_posibles = stock_disp_comp // cant_necesaria
