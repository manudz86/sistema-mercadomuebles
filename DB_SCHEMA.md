...
## `stock_comprometido_ventas`  _(filas: 40)_
...
- **`canal`** → `Mercado Libre` (2,792), `tienda_web` (91), `Fuera de ML` (48)
- **`metodo_pago`** → `MercadoPago` (2,858), `Efectivo` (37), `GetNet` (9), `Transferencia` (8), `Payway` (8), `Mixto` (7), `Tarjeta` (4)
- **`tipo_entrega`** → `Envío` (2,807), `Retiro` (124)
- **`metodo_envio`** → `Colecta` (786), `Delega` (641), `Flex` (608), `Flete Propio` (413), `Full` (130), `Zippin` (113), `` (87), `Mercadoenvios` (61), `Turbo` (50), `ME2` (4)
- **`ubicacion_despacho`** → `DEP` (2,801), `FULL` (130)
- **`zona_envio`** → `` (2,478), `Capital` (127), `Sur` (113), `Oeste` (93), `Norte-Noroeste` (79)
- **`responsable_entrega`** → `` (1,249)
- **`estado_pago`** → `pagado` (2,904), `pago_pendiente` (25), `pago_parcial` (1), `pendiente` (1)
- **`estado_entrega`** → `entregada` (2,756), `pendiente` (94), `cancelada` (77), `en_proceso` (4)
- **`estado`** → `ACTIVA` (2,930), `CANCELADA` (1)
- **`factura_doc_type`** → `DNI` (2,542), `CUIT` (215)
- **`factura_taxpayer_type`** → `Consumidor Final` (2,601), `Responsable Inscripto` (97), `IVA Responsable Inscripto` (50), `Responsable Monotributo` (3), `IVA Exento` (2), `Sujeto No Categorizado` (2), `Monotributo` (1), `Exento` (1)

---

## `ventas_activas`  _(filas: 94)_
...
- **`canal`** → `Mercado Libre` (82), `tienda_web` (9), `Fuera de ML` (3)
- **`metodo_pago`** → `Mercadopago` (90), `Efectivo` (3), `GetNet` (1)
- **`tipo_entrega`** → `envio` (85), `retiro` (9)
- **`metodo_envio`** → `Flete Propio` (27), `Delega` (25), `Colecta` (12), `Zippin` (12), `Flex` (8), `` (4), `Turbo` (1)
- **`zona_envio`** → `` (61), `Oeste` (11), `Capital` (8), `Sur` (4), `Norte-Noroeste` (4)
- **`responsable_entrega`** → `` (28)
- **`estado_pago`** → `pagado` (94)
- **`estado_entrega`** → `pendiente` (94)
